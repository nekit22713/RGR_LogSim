...
namespace LogicSimulator.Views.Shapes {
    public partial class Switch: GateBase, IGate, INotifyPropertyChanged {
        ...
        private void Release(object? sender, PointerReleasedEventArgs e) {
            ...
            my_state = !my_state;
            border.Background = new SolidColorBrush(Color.Parse(my_state ? "#9ACD32" : "#ffff"));
        }
        ...
        public override void ExtraImport(string key, object extra) {
            ...
            my_state = @state;
            if (my_state) border.Background = new SolidColorBrush(Color.Parse("#9ACD32"));
        }
        ...
        public void SetState(bool state) {
            my_state = state;
            border.Background = new SolidColorBrush(Color.Parse(state ? "#9ACD32" : "#ffff"));
        }
    }
}
